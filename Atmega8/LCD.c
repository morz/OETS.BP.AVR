...
/* Параметры:														    */
/*		    @cmd = 1 байт данных для отправки                           */
/************************************************************************/
...
/* Параметры:														    */
/*		    @data = 1 байт данных для отправки                          */
/************************************************************************/
...
/* Настройка всех необходимых портов, сброс значений				    */
/************************************************************************/
void lcd_init()
{
	data_ddr = 0xFF;
...
/* Параметры:														    */
/*		    @pos_x = позиция x. Значения от 0 до 7.				        */
/************************************************************************/
...
/* Параметры:														    */
/*		    @pos_y = позиция y. Значения от 0 до 63.			        */
/************************************************************************/
